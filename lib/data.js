const projects = {
    light: [{
            ...
            media: [{
                    type: 'image',
                    src: '/projects/light/oxxi_img1.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img2.png'
                },
                {
                    type: 'video',
                    src: '/projects/light/oxxi_vid.mov'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img3.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img4.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img5.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img6.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/oxxi_img7.png'
                },
            ]
        },
        {
            ...
            media: [{
                    type: 'image',
                    src: '/projects/light/trst_img1.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/trst_img2.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/trst_img3.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/trst_img4.png'
                },
                {
                    type: 'image',
                    src: '/projects/light/trst_img5.png'
                },

                {
                    type: 'video',
                    src: '/projects/light/trst_vid1.mp4'
                },
                {
                    type: 'video',
                    src: '/projects/light/trst_vid2.mp4'
                },
                {
                    type: 'video',
                    src: '/projects/light/trst_vid3.mp4'
                },
                {
                    type: 'video',
                    src: '/projects/light/trst_vid4.mp4'
                },
            ]
        },
        // {
        ...
        //     media: [{
        //             type: 'image',
        //             src: '/projects/light/oxxi_image1.png'
        //         },
        //         {
        //             type: 'image',
        //             src: '/projects/light/oxxi_image2.png'
        //         },
        //         {
        //             type: 'video',
        //             src: '/projects/light/oxxi_video1.mp4'
        //         }
        //     ]
        // },
        // {
    ...
    generative: [{
            ...
            media: [{
                    type: 'image',
                    src: '/projects/generative/fields95_img1.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/generative/fields95_img2.jpg'
                },
                {
                    type: 'video',
                    src: '/projects/generative/fields95_vid.mp4'
                },
            ]
        },
        {
            id: 2,
            title: 'winter_lady', // ВОЗМОЖНО В ДРУГОЙ РАЗДЕЛ
            img: '/projects/generative/winterlady_main.png',
            textRu: "Визуальный проект о холодной зиме, сверкающей, далекой",
            textEn: "Visual project about cold winter, sparkling, distant",
            date: '',
            media: [{
                    type: 'youtube',
                    src: 'https://www.youtube.com/embed/xg0PweMSRx0?si=zD4vBWiTLEeh9lJG?rel=0'
                },
                {
                    type: 'image',
                    src: '/projects/generative/winterlady_main.png'
                },
                // {
                //     type: 'image',
                //     src: '/projects/generative/oxxi_image2.png'
                // },
            ]
        },
        {
            id: 3,
            title: 'devils', // ВОЗМОЖНО В ДРУГОЙ РАЗДЕЛ
            img: '/projects/generative/devils_main.png', // УЖАТЬ ИЛИ ЗАЛИТЬ С ОБЛАКА
            ...
            date: '',
            media: [
                // { type: 'image', src: '/projects/generative/oxxi_image1.png' },
                // { type: 'image', src: '/projects/generative/oxxi_image2.png' },
                {
                    type: 'video',
                    src: '/projects/generative/devils.vid.mov'
                }, // УЖАТЬ ИЛИ ЗАЛИТЬ С ОБЛАКА
            ]
        },
        {
            id: 4,
            title: 'blood', // ВОЗМОЖНО В ДРУГОЙ РАЗДЕЛ
            img: '/projects/generative/blood_main.png', // УЖАТЬ ИЛИ ЗАЛИТЬ С ОБЛАКА
            ...
            media: [{
                    type: 'image',
                    src: '/projects/generative/blood_img1.png'
                },
                {
                    type: 'video',
                    src: '/projects/generative/blood_vid.mp4'
                },
            ]
        },
        {
            id: 5,
            title: 'touch',
            img: '/projects/generative/touch_main.jpg',
            textRu: "Исследование взаимоотношений человека, технологий и чувств. Аллегория божественного прикосновения в этом контексте символизирует высшую форму контакта, который выходит за рамки физического взаимодействия и проникает в сферу духовного и эмоционального. Это прикосновение – символ бесконечного стремления человека к знаниям и истинное удовлетворение. Искусственный интеллект уже способен анализировать огромные объемы данных и принимать решения, которые могут показаться интуитивными. Но бесконечное развитие так или иначе ведет к самосознанию и рефлексии.",
            textEn: `Audioreactive 3d project  (touchdesigner + blender). A study of the relationship between man, technology and the senses. The connection of spiritual and philosophical aspects with modern realities, where technology is becoming an integral part of our lives.The allegory of divine touch in this context symbolizes the highest form of contact, which goes beyond physical interaction and penetrates into the realm of the spiritual and emotional. This touch is a symbol of the endless human desire for knowledge and true satisfaction. Artificial intelligence is already capable of analyzing huge amounts of data and making decisions that may seem intuitive. But endless development one way or another leads to self-awareness, and therefore to reflection. We are able to look at technology not only as tools, but also as potential participants in our emotional and spiritual world.`,
            date: '',
            media: [{
                    type: 'image',
                    src: '/projects/generative/touch_img1.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/generative/touch_img2.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/generative/touch_img3.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/generative/touch_img4.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/generative/touch_main.jpg'
                },
                {
                    type: 'video',
                    src: '/projects/generative/touch_vid.mp4'
                },
            ]
        },
    ],
    ...
    threed: [{
            ...
            media: [{
                    type: 'image',
                    src: '/projects/threed/signal_img1.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img2.png'
                },
                {
                    type: 'video',
                    src: '/projects/threed/signal_vid.mp4'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img3.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img4.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img5.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img6.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img7.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img8.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/signal_img9.png'
                },
            ]
        },
        {
            ...
            media: [{
                    type: 'image',
                    src: '/projects/threed/heart_img1.png'
                },
                {
                    type: 'image',
                    src: '/projects/threed/heart_img2.png'
                },
                {
                    type: 'youtube',
                    src: 'https://www.youtube.com/embed/kAB-32pVZW4?si=Cu4QB2PKXrWd07gC?rel=0'
                },
                {
                    type: 'video',
                    src: '/projects/threed/heart_vid1.mov'
                },
                {
                    type: 'video',
                    src: '/projects/threed/heart_vid2.mov'
                },
                {
                    type: 'video',
                    src: '/projects/threed/heart_vid3.mov'
                },
                {
                    type: 'video',
                    src: '/projects/threed/heart_vid4.mov'
                },
            ]
        },
        {
            ...
            img: '/projects/threed/room_main.jpg',
            textRu: "Это концепт инсталляции, которая должна работать на контрасте с темным шумным помещением (например, в заброшке техно феста); при условии дыма комната может создавать некоторое ощущение левитации, также здесь решетки из двух слоев: один слой это сильно отражающий свет материал, другой слой - решетки из лед лент миллион паттернов, а если поставить зеркала за всей конструкцией, то _бесконечное ощущение бесконечности  благодаря световым рефлективам",
            textEn: "Installation \"Futuristic room\" with the self-explanatory name Dark is a levitating room due to multi-layered light. There's space in it seems unreal:graphics of clear perspective grids reminds aestheticsretrofuturism, gradually disappearing because of reflective surfaces and smoke.If we can use mirrors, a feeling of infinity may arise repeating pattern, immersing the viewer in a peculiarlight tunnel.A bright, calm zone in a large and always moving darkness. The installation concept was presented on the short list of winners of the multimedia art call of the Outline festival.",
            date: '',
            media: [{
                    type: 'image',
                    src: '/projects/light/oxxi_image1.png'
    ...
    collabs: [{
        ...
        },
        {
            ...
            media: [{
                    type: 'image',
                    src: '/projects/collabs/bunny_img1.png'
                },
                {
                    type: 'image',
                    src: '/projects/collabs/bunny_img2.png'
                },
                {
                    type: 'image',
                    src: '/projects/collabs/bunny_img3.png'
                },
                {
                    type: 'image',
                    src: '/projects/collabs/bunny_img4.jpg'
                },
                {
                    type: 'image',
                    src: '/projects/collabs/bunny_img5.jpg'
                },
            ]
        },
        {
        ...
        },
        {
            ...
            textRu: "Наконец мама Муми-тролля торжественно сказала:— Огромное спасибо за помощь, прекрасная дама!А Муми-тролль поклонился ниже, чем всегда, по тому что прекраснее девочки с голубыми волосами он никого в своей жизни не видел.— Вы все время живете в тюльпане? — застенчиво спросил маленький зверек.— Это мой дом, — ответила она. — Можешь называть меня Тюлиппа.И они стали медленно грести, переплывая на другую сторону болота. Там плотной стеной росли папоротники, и под ними мама устроила для них гнездо во мху, чтобы все могли поспать. Муми-тролль",
            textEn: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores beatae, ipsum consequuntur exercitationem voluptas laborum nisi blanditiis reiciendis numquam, ipsam non eaque quaerat quos sed omnis doloribus pariatur nihil? Beatae!",
            date: '',
            media: [{
                    type: 'image',
